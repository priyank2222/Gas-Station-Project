...
<% List<FinalTransaction> list = (List<FinalTransaction>)request.getAttribute("list");%>
...
<td style="padding: 10px 0;"> <%=transaction.getToday() %></td>
...
<td style="padding: 10px 0;"> <%=transaction.getTankname()%></td>
<td style="padding: 10px 0;"> <%=transaction.getQuantity() %></td>
